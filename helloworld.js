...
Elm.HelloWorld.make = function (_elm) {
   ...
   _L.fromArray([A2($Html.div,
   _L.fromArray([$Html$Attributes.$class("twelve column")]),
   _L.fromArray([A2($Html.h1,
                _L.fromArray([]),
                _L.fromArray([$Html.text("My first amazing app")]))
                ,par(_L.fromArray(["Elm is an amazing langage to create HTML/JS web-applications. "
